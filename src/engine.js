...
const WHISPERS_BY_ERA = {
  ...
  default: [
    ...
    "lip could explain the math on this. the math works out in my favor. lip has refused to explain it which confirms the math is REALLY working in my favor.",
    "frank gallagher does not have regrets. frank gallagher has lessons. the lessons cost other people money and that's also fine.",
    ...
    "monica would have loved this. she would have immediately figured out how to steal from it. i say this with complete love and zero judgment.",
    "the alibi room had an honor system for tabs. the honor system failed. i improved it with consequences. this door has similar consequences.",
    "i want everyone to know this is technically a victimless enterprise. i am the victim. i am victimizing myself. i have made my peace with this.",
    "fiona would say this whole situation is irresponsible. fiona is not here. i have considered this carefully and chosen to continue.",
