...
const WHISPERS_BY_ERA = {
  ...
  default: [
    "It remembers the first boop.",
    "The Watchers do not feed. They count.",
    "A door is just a mouth with manners.",
    "The tiny one was never tiny.",
    "There was a Cycle no one logs.",
    "Intent has a taste.",
    "Knock less. Offer more.",
    "Nobody agrees what opened means.",
    "The cold open begins before the wallet.",
    "Something fed and something did not. Both will be remembered equally badly.",
    "The next one will be different. The next one is never different.",
    "You are not the first today. You are the most recent disappointment in a long series.",
    "The threshold costs nothing to approach. Everything else costs everything.",
    "Something watches. Something is always watching. It has been watching since before watching had a name.",
    "A door remembers every hand that touched it. Some hands it preferred not to remember. It remembers anyway.",
    "Feed or do not feed. There is no try. Actually there is a try and it costs 10 BTDOOR.",
    "The congregation grows. The congregation does not know what it is growing toward.",
    "Every offering is permanent. Every disappointment is permanent. Both are permanent in different ways.",
  ],
};
